...
function WriteResponse(employees) {
    var strResult = "<table><th>ID</th><th>First Name</th><th>Last Name</th><th>Email</th>";
    $.each(employees, function (index, employee) {
        strResult += "<tr><td>" + employee.CustomerKey + "</td><td> " + employee.FirstName + "</td><td>" + employee.LastName + "</td><td>" + employee.EmailAddress + "</td></tr>";
    });
    strResult += "</table>";
